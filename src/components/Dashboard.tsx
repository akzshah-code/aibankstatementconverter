...
const Dashboard = ({ user }: DashboardProps) => {
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="bg-brand-purple-light p-6 rounded-lg shadow-md flex items-center justify-between">
                ...
                <a href="#pricing" className="bg-brand-purple text-white px-4 py-2 rounded-md font-semibold hover:bg-opacity-90 transition-colors duration-200 whitespace-nowrap">
                    View Plans
                </a>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                />
                 <StatCard 
                    icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-brand-purple" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>}
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <div className="w-full bg-gray-200 rounded-full h-2.5">
                    <div className="bg-brand-purple h-2.5 rounded-full" style={{ width: `${usagePercentage}%` }}></div>
                </div>
