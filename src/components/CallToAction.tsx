  ...
  return (
    <section className="py-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-brand-purple-light rounded-lg p-8 md:p-12">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div>
              <a
                href="#contact"
                className="inline-block bg-brand-purple text-white px-8 py-3 rounded-md font-semibold hover:bg-opacity-90 transition-colors duration-200 whitespace-nowrap"
              >
                Contact Us
              </a>
            </div>
